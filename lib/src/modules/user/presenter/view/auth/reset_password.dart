import 'package:dreampuppy/src/modules/user/domain/auth/usecases/fetch_email.dart';
import 'package:dreampuppy/src/modules/user/domain/auth/usecases/reset_password.dart';
...
class ResetPasswordPage extends StatelessWidget {
  ...
  late final ResetPasswordUseCase forgotPasswordUseCase =
      Modular.get<ResetPasswordUseCase>();
  late final FetchEmailUseCase fetchEmailFromPasswordRecoveryUseCase =
      Modular.get<FetchEmailUseCase>();
                  ...
                  FutureBuilder<String>(
                      ...
                      builder: (context, snapshot) {
                        if (snapshot.connectionState == ConnectionState.done) {
                          return Text(
                              'Trocar senha do email: ${snapshot.data}');
                        }
                        return Container();
                      }),
